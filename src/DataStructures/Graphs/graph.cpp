...
void Graph::initialize(std::string(&nodes)[], std::string(&edges)[], size_t size) {
...
void Graph::initialize(std::vector<std::string>& nodes, std::vector<std::string>& edges, size_t size) {
...
void Graph::initialize(std::vector<std::string>& nodes, weighted_edge(&edges)[], size_t size) {
...
void Graph::initialize(std::string(&nodes)[], weighted_edge(&edges)[], size_t size) {
...
void Graph::make_edge(const std::string& parent, const std::string& child, double parent_to_child_weight) {
...
void Graph::kosarajus_algorithm(std::vector<std::vector<std::string>>& memo) {
	...
	SmartList<SmartList<String>>* memoLists = new SmartList<SmartList<String>>;
